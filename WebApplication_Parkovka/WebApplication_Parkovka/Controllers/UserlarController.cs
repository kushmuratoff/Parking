...
namespace WebApplication_Parkovka.Controllers
{
    public class UserlarController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="Id,Login,Parol,RollarId")] Userlar userlar)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="Id,Login,Parol,RollarId")] Userlar userlar)
        {
            if (ModelState.IsValid)
            {
